...
Source0  : https://cpan.metacpan.org/authors/id/D/DB/DBOOK/Module-Starter-1.78.tar.gz
...
%prep
%setup -q -n Module-Starter-1.78
cd %{_builddir}
tar xf %{_sourcedir}/libmodule-starter-perl_1.750+dfsg-1.debian.tar.xz
cd %{_builddir}/Module-Starter-1.78
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Module-Starter-1.78/deblicense/
