...
cd %{_builddir}/Module-Starter-1.76
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Module-Starter-1.76/deblicense/
...
cp %{_builddir}/Module-Starter-1.76/LICENSE %{buildroot}/usr/share/package-licenses/perl-Module-Starter/692157650d7c2ff31aeb3ccac32672aa843d1d7d
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Module-Starter/692157650d7c2ff31aeb3ccac32672aa843d1d7d
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter.pm
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter/App.pm
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter/BuilderSet.pm
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter/Plugin.pod
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter/Plugin/Template.pm
/usr/lib/perl5/vendor_perl/5.30.1/Module/Starter/Simple.pm
